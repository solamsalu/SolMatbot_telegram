...
const calculusCommand = require('./commands/calculus');
const algebraCommand = require('./commands/algebra');
const feedbackCommand = require('./commands/feedback');
const resourcesCommand = require('./commands/resources');
const discussionCommand = require('./commands/discussion');
const eventsCommand = require('./commands/events');
const contactCommand = require('./commands/contact');
const mathtipsCommand = require('./commands/mathtips');
const quizzesCommand = require('./commands/quizzes');
...
algebraCommand(bot);
feedbackCommand(bot);
resourcesCommand(bot);
discussionCommand(bot);
eventsCommand(bot);
contactCommand(bot);
mathtipsCommand(bot);
quizzesCommand(bot);
...
bot.on('callbackQuery', async (msg) => {
    ...
    if (await canUseBot(msg.from.id, chatId)) {
        switch (data) {
            case '/calculus': calculusCommand.showMenu(bot, chatId); break;
            case '/algebra': algebraCommand.showMenu(bot, chatId); break;
            case '/feedback': feedbackCommand(bot, chatId); break;
