      ...
      switch (callbackData) {
            ...
            case '/calculus1_outline':
               bot.sendMessage(chatId,
                  ...
                  "You can download the complete course outline here: <a href='https://raw.githubusercontent.com/solamsalu/SolMatbot_telegram/main/content/Calculus%20I%20for%20Mathematics.pdf'>Download Course Outline</a>",
                  {
                     parseMode: 'HTML',
                     replyMarkup: bot.inlineKeyboard([
                        [bot.inlineButton('🔙 Back', { callback: 'calculus1_start' })],
         ...
         case '/calculus1_ch1':
            bot.sendMessage(chatId,
               ...
               "Reference: <a href='https://drive.google.com/file/d/1ujo10NMvLCGmfNpvP0CUehX6iKHQ7ibT/view?usp=sharing'>Download Reference</a>",
               { 
                  parseMode: 'HTML',
                  replyMarkup: bot.inlineKeyboard([
                     [bot.inlineButton('🔙 Back', { callback: '/calculus1_ch1_menu' })],
                     [bot.inlineButton('🏠 Main Page', { callback: '/start' })]
                  ])
                }
            );
         ...
         case '/calculus1_ch2_menu':
            bot.sendMessage(chatId,
               ...
               replyMarkup: bot.inlineKeyboard([
                  ...
                  [bot.inlineButton('🔙 Back', { callback: '/calculus1_ch2_menu' })],
                  [bot.inlineButton('🏠 Main Page', { callback: '/start' })]
               ])
            });
            break;
         ...
         case '/calculus1_ch3_menu':
            bot.sendMessage(chatId,
               ...
               replyMarkup: bot.inlineKeyboard([
                  ...
                  [bot.inlineButton('🔙 Back', { callback: '/calculus1_ch3_menu' })],
                  [bot.inlineButton('🏠 Main Page', { callback: '/start' })]
               ])
            });
            break;
         ...
         case '/calculus1_ch4_menu':
            bot.sendMessage(chatId,
               ...
               replyMarkup: bot.inlineKeyboard([
                  ...
                  [bot.inlineButton('🔙 Back', { callback: '/calculus1_ch4_menu' })],
                  [bot.inlineButton('🏠 Main Page', { callback: '/start' })]
               ])
            });
            break;
