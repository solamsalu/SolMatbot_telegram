      ...
      switch (callbackData) {
         ...
         case '/appliedmath3_outline':
            bot.sendMessage(chatId,
               ...
               "4. <b>Vector Calculus</b>: Scalar and vector fields, curves, arc length, tangents, gradients, divergence, curl, line integrals, Green's theorem, surface integrals, divergence theorem, Stokes' theorem, applications.\n" +
               "5. <b>Line and Surface Integrals</b>: Line Integrals, Green's Theorem, Surface Integrals and Divergence and Stock's Theorems.\n" +
         ...
         case '/appliedmath3_as1':
            bot.sendMessage(chatId,
               ...
               "You can download the PDF here: <a href='https://raw.githubusercontent.com/solamsalu/SolMatbot_telegram/8eeb6ea3e7e6edb2f7780e049e562d1f069fc921/content/Applied%20III%20Assi_1.pdf'>Download Assignment 1</a>",
               {
                  parseMode: 'HTML',
                  replyMarkup: bot.inlineKeyboard([
                     [bot.inlineButton('🔙 Back', { callback: 'appliedmath3_start' })],
   ...
   function sendAppliedMath3Menu(chatId) {
      bot.sendMessage(chatId, "<b>         Applied Math III (Math 2072)</b>", {
         ...
         replyMarkup: bot.inlineKeyboard([
            ...
            [bot.inlineButton('📖 Chapter 4: Vector Calculus', { callback: '/appliedmath3_ch4_menu' })],
            [bot.inlineButton('📖 Chapter 5: Line and Surface Integrals', { callback: '/appliedmath3_ch5_menu' })],
