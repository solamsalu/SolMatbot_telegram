      ...
      switch (callbackData) {
         ...
         case '/appliedmath3_ws3':
            bot.sendMessage(chatId, "<b>Worksheet 3: Laplace Transform</b>\n\n" +
               ...
               "You can download the PDF here: <a href='https://raw.githubusercontent.com/solamsalu/SolMatbot_telegram/621a13ecb0e4e586e0e24dd9ba82e7cc8ddfc471/content/Applied%20III%20WS%20-%203%20(Laplace%20Transform).pdf'>Download Worksheet 3</a>",
               {
                  parseMode: 'HTML',
                  replyMarkup: bot.inlineKeyboard([
                     [bot.inlineButton('🔙 Back', { callback: '/appliedmath3_ch3_menu' })],
         ...
         case '/appliedmath3_as1':
            bot.sendMessage(chatId,
               ...
               "You can download the PDF here: <a href='https://raw.githubusercontent.com/solamsalu/SolMatbot_telegram/621a13ecb0e4e586e0e24dd9ba82e7cc8ddfc471/content/Applied%20III%20Assi_1.pdf'>Download Assignment 1</a>",
               {
                  parseMode: 'HTML',
                  replyMarkup: bot.inlineKeyboard([
                     [bot.inlineButton('🔙 Back', { callback: 'appliedmath3_start' })],
